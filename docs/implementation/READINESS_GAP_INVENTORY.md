...
- Next safe repo-only stage: Repo-Wide iPhone Readiness Audit v1 should audit remaining iPhone/Siri/Shortcuts/Health/setup readiness gaps and separate safe Codex tasks from Todd/device/account boundaries before new implementation.
