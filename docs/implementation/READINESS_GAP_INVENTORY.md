...
- Current safe repo-only docs stage: Device Setup Runbook Baseline Refresh aligns durable setup/current-state docs to the PR #44 readiness audit baseline before new implementation.
