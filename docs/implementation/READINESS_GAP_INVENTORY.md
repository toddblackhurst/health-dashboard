...
- Current safe repo-only stage: Repo-Wide iPhone Readiness Audit v1 records remaining iPhone/Siri/Shortcuts/Health/setup readiness gaps in `docs/implementation/IPHONE_READINESS_AUDIT.md` and separates safe Codex tasks from Todd/device/account/admin boundaries before new implementation.
