...
- Current safe repo-only docs task: Shortcuts Promotion and Discovery Matrix v1 maps promoted versus implemented/unpromoted intents and Todd's expected Shortcuts/Siri discovery behavior before any device setup or implementation. Working doc: `docs/implementation/SHORTCUTS_PROMOTION_DISCOVERY_MATRIX.md`.
