...
final class CoachTodaySummaryTests: XCTestCase {
    ...
    func testDailyDataFreshnessReportShowsMissingSetupAndStableNextActions() throws {
        ...
        XCTAssertTrue(text.contains("source_state: missing"))
        XCTAssertTrue(text.contains("protected_read_only_freshness: not_configured"))
        XCTAssertTrue(text.contains("source_state: permission_required"))
        ...
        XCTAssertTrue(text.contains("source_state: draft_only"))
    ...
    func testDailyDataFreshnessReportMarksRecentLocalDataFreshAndManualSourcesDeferred() throws {
        ...
        XCTAssertTrue(text.contains("source_state: verified_read_only"))
    ...
    func testDailyDataFreshnessSourcesExposeStableFutureSurfaceFields() throws {
        ...
        XCTAssertEqual(health.sourceState, "missing")
        ...
        XCTAssertTrue(health.line.contains("source_state: missing"))
        ...
        XCTAssertEqual(protected.sourceState, "permission_required")
